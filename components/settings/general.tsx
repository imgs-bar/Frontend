...
export default function General() {
    ...
    <Select
      ...
      onSelect={x => {
        ...
        setState(state => ({
          ...
          selectedDomain: {
            ...domain,
            subdomain: domain.wildcard ? '' : selectedDomain.subdomain,
          },
        }));
      }}
    >
  ...
  const formatEmbedField = (fmt: string) => {
    ...
    fmt = fmt
      ...
      .replace(
        '{domain}',
        selectedDomain.subdomain !== '' && selectedDomain.wildcard
          ? `${selectedDomain.subdomain}.${selectedDomain.name}`
          : selectedDomain.name
      )
      ...
      <div className={styles.section}>
        ...
        <div className={styles.switchCon}>
          <div style={{marginRight: 20}}>
            <p className={`ant-statistic-title ${styles.switchCap}`}>
              URL Settings
            </p>
            ...
            <div className={styles.switch}>
              <Tooltip
                placement="topRight"
                title="Long URL will make your filename 17 characters instead of 7."
              >
            ...
            <div className={styles.switch}>
              <Tooltip
                placement="topRight"
                title="Show Link will stop discord hiding image links."
              >
            ...
            <div className={styles.switch}>
              <Tooltip
                placement="topRight"
                title="Invisible Filename will get rid of the filename at the end of the link of the image."
              >
            ...
            <div className={styles.switch}>
              ...
              <Tooltip
                placement="topRight"
                title="Fake URL will show fake urls, this only works on discord and might be patched soon!"
              >
          ...
          <div>
            ...
            <div className={styles.switch}>
              ...
              <Tooltip
                placement="topRight"
                title="Embeds will allow you to have a custom title, description, and color on your images."
              >
                <p style={{cursor: 'pointer', marginRight: 3}}>
                  Discord Embeds
                </p>
              </Tooltip>
            ...
            <div className={styles.switch}>
              {user.settings.autoWipe.enabled && (
                <Button
                  type="primary"
                  onClick={() =>
              ...
              <Tooltip
                placement="topRight"
                title="Auto-file wiping will automatically wipe your files based on a interval you provide."
              >
                <p style={{cursor: 'pointer', marginRight: 1}}>
                  Auto File Wiping
                </p>
              </Tooltip>
            ...
            <div className={styles.switch} style={{marginBottom: 5}}>
              ...
              <Tooltip
                placement="topRight"
                title="Random domain will choose a random domain from a list you provide."
              >
        ...
        <div className={styles.previewCon}>
          <div className={styles.embedSettings}>
            ...
            <div>
              ...
              <AutoComplete
                ...
                value={
                  embed.title && embed.title !== '' && embed.title !== 'default'
                    ? embed.title
                    : ''
                }
                filterOption={(input, option) => {
                ...
                onSelect={(_input, option) => {
                  ...
                  user = Object.assign({}, user);
                  user.settings.embed.title = `${
                    embed.title === 'default' ? '' : embed.title
                  }${
                    embed.title.length > 0 && embed.title !== 'default'
            ...
            <div>
              ...
              <AutoComplete
                ...
                onSelect={(_input, option) => {
                  ...
                  user = Object.assign({}, user);
                  user.settings.embed.description = `${
                    embed.description === 'default' ? '' : embed.description
                  }${
                    embed.description.length > 0 &&
                    embed.description !== 'default'
                      ? option.value.split(
                          embed.description.split(' ').splice(-1)
                        )[1]
                      : option.value
                  }`;
          ...
          >
            ...
            {embed.description !== 'test' && (
              ...
              >
                {embed.description === 'default'
                  ? `Uploaded at ${new Date().toLocaleString()} by ${
                      user.username
                    }.`
                  : formatEmbedField(embed.description)}
              </span>
            )}
          ...
          <div className={styles.fakeUrlSettings}>
            <div>
              <AutoComplete
                ...
                value={user.settings.fakeUrl.url}
                onSelect={(_input, option) => {
                  user = Object.assign({}, user);
