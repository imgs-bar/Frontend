...
export default function UploadC() {
    ...
    selectedDomain: {
      ...
      wildcard: domains.find(d => d.name === user.settings.domain.name)
        ? // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          // @ts-ignore
          domains.find(d => d.name === user.settings.domain.name).wildcard
        : false,
      subdomain:
  ...
  const [{selectedDomain, showLink, invisibleUrl, randomDomain}, setState] =
      ...
      <div className={styles.page}>
        <div className={styles.section}>
          ...
          <div className={styles.switchContainer}>
            <h1 className={styles.title} style={{marginLeft: 0, marginTop: 5}}>
              URL Settings
            </h1>
