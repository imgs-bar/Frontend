        ...
        >
          <Menu style={{border: 'none'}}>
            ...
            <SubMenu
              ...
              title="Settings"
            >
              <Menu.Item key="1" onClick={() => router.push('/settings')}>
                General
              </Menu.Item>
              <Menu.Item
                key="2"
            ...
            <SubMenu
              ...
              title="Tools"
            >
              <Menu.Item key="1" onClick={() => router.push('/tools/upload')}>
                Upload
              </Menu.Item>
              <Menu.Item key="2" onClick={() => router.push('/tools/shorten')}>
                Shorten
              </Menu.Item>
            </SubMenu>
            <Menu.Item
