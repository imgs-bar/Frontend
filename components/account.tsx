...
export default function Account() {
  ...
  const [{changeModal, newUsername, newPassword, password}, setState] =
    ...
    <div className={styles.container}>
      ...
      <div className={styles.page}>
        <div className={styles.section}>
          ...
          <Form layout="vertical" name="basic" initialValues={{remember: true}}>
            <Form.Item className={styles.accountInput} label="UUID" name="uuid">
              <Input
                disabled
                style={{
            ...
            <Form.Item className={styles.accountInput} label="UID" name="uid">
              <Input
                disabled
                style={{
                  backgroundColor: 'transparent',
            ...
            <Form.Item className={styles.accountInput} label="Role" name="role">
              <Input
                disabled
                style={{
                  backgroundColor: 'transparent',
          ...
          <div className={styles.btnContainer}>
            ...
            <Button
              onClick={() => setState(state => ({...state, changeModal: true}))}
      ...
      >
        ...
        >
          ...
          <Button onClick={setUsername} className={styles.changeBtn}>
            Change Username
          </Button>
        </div>
        ...
        <div>
          ...
          <Button onClick={setPassword} className={styles.changeBtn}>
            Change Password
          </Button>
        </div>
      </Modal>
