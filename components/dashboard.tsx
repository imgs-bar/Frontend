...
export default function Dashboard() {
    ...
    try {
      ...
      if (data.success) {
        ...
        (user.images = user.images.filter(
          (x: any) => x.filename !== image.filename
        )),
    ...
    },
    {
      ...
      render: (record: any) => (
        <span
          ...
          onClick={() => {
            navigator.clipboard.writeText(`https://imgs.gifts/${record._id}`);
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>imgs.bar Dashboard</title>
      </Head>
      ...
      <div className={styles.dashboard}>
        <div className={styles.section}>
          ...
          <div className={styles.statsCon}>
            <Card className={styles.statsBox}>
              ...
              >
                Manage Invites (
                <strong>{user.admin ? '∞' : user.invites}</strong>)
              </Button>
            </Card>

            <Card className={styles.statsBox}>
              <div className="ant-statistic-title">
                <CloudUploadOutlined /> Uploads
              </div>
              <div className={styles.statContent}>
                You have uploaded <strong>{user.uploads}</strong> files.
              </div>
            </Card>

            <Card className={styles.statsBox}>
              <div className="ant-statistic-title">
                <MessageOutlined /> MOTD
              </div>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.galleryCaption}>
            Here you can view your last uploads.
          </p>
